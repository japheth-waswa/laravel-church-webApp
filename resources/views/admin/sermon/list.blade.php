...
<div class="page-content">
    ...
    <h1 class="page-title"> Sermon List
        <small>all sermon listing</small>
    </h1>
    <div class="page-bar">
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Sermons</span>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="btn-group">
                                    ...
                                    <a href="{{route('sermon.create')}}">
                                        <button id="sample_editable_1_new" class="btn sbold green"> Add New Sermon
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td> 
                                    <div class="mt-img">
                                        <img src="{{ asset($sermon->image_url) }}" class="img-responsive img-thumbnail"> 
                                    </div>
                                </td>
                                ...
                                <td class="center"> {{ Helpers::formatDateBasic($sermon->sermon_date) }} </td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            <li>
                                                @if($sermon->visible == 1)
                                                <a href="{{ route('sermon.visibility',array($sermon->id,'0')) }}">
                                                    <i class="icon-eye"></i> Set Invisible
                                                </a>
                                                @else
                                                <a href="{{ route('sermon.visibility',array($sermon->id,'1')) }}">
                                            ...
                                            <li class="divider"> </li>
                                            <li>
                                                    <a href="{{ route('sermon.edit',$sermon->id) }}">
                                            ...
                                            <li class="divider"> </li>
                                            <li>
                                                 <form role="form" action="{{ route('sermon.destroy',$sermon->id) }}" method="post" >
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
