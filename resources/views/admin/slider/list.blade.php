...
<div class="page-content">
    ...
    <h1 class="page-title"> Slider List
        <small>all slider listing</small>
    </h1>
    <div class="page-bar">
                            ...
                            <div class="col-md-12">
                                <div class="btn-group">
                                    ...
                                    <a href="{{route('slider.create')}}">
                                        <button id="sample_editable_1_new" class="btn sbold green"> Add New Slider
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td> 
                                    <div class="mt-img">
                                        <img src="{{ asset($slider->image_url) }}" class="img-responsive img-thumbnail"> 
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            <li>
                                                @if($slider->visible == 1)
                                                <a href="{{ route('slider.visibility',array($slider->id,'0')) }}">
                                                    <i class="icon-eye"></i> Set Invisible
                                                </a>
                                                @else
                                                <a href="{{ route('slider.visibility',array($slider->id,'1')) }}">
                                            ...
                                            <li class="divider"> </li>
                                            <li>
                                                 <form role="form" action="{{ route('slider.destroy',$slider->id) }}" method="post" >
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
