                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center"> {{ Helpers::formatDateBasic($sundayschedules->sunday_date) }} </td>
                                <td class="center"> {{ count($sundayschedules->sundaypages) }} </td>
                                <td>
                                    @if($sundayschedules->visible == 1)
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            <li>
                                                <a href="{{ route('sunday.show',$sundayschedules->id) }}">
                                                    <i class="icon-docs"></i> Manage Pages
                                                </a>
                                            </li>
                                            <li class="divider"> </li>
                                            ...
                                            <li>
                                                @if($sundayschedules->visible == 1)
                                                <a href="{{ route('sunday.visibility',array($sundayschedules->id,'0')) }}">
                                                    <i class="icon-eye"></i> Set Invisible
                                                </a>
                                                @else
                                                <a href="{{ route('sunday.visibility',array($sundayschedules->id,'1')) }}">
                                            ...
                                            <li class="divider"> </li>
                                            <li>
                                                <a href="{{ route('sunday.edit',$sundayschedules->id) }}">
                                            ...
                                            <li class="divider"> </li>
                                            <li>
                                                <form role="form" action="{{ route('sunday.destroy',$sundayschedules->id) }}" method="post" >
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
